                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <p>Printer Device</p>
                                <a href="{{ route('printer-device.pdf') }}" class="btn btn-primary mb-4">Export PDF</a>
                                <!-- DataTables -->
                                <div align="right">
                                        ...
                                        <div class="card">
                                            <div class="card-body">            
                                                <div class="d-inline-block">
                                                    <h3 class="text-black">{{ DB::table('printer_devices')->where('sisa_stok','0')->count(); }}</h3>
                                                ...
                                                &nbsp;
                                                <div class="d-inline-block">
                                                    <h3 class="text-black">{{ DB::table('printer_devices')->where('sisa_stok','1')->count(); }}</h3>
