                            ...
                            <table class="table table-striped table-bordered zero-configuration"> 
                                    ...
                                    @foreach ($data as $aksesoris)
                                        <tr>
                                            ...
                                            <td><p>{{ $aksesoris->sn_desktop }}</p></td>
                                            <td><p>{{ $aksesoris->brand_desktop }}</p></td>
                                            <td><p>{{ $aksesoris->model_desktop }}</p></td>
                                            <td><p>{{ $aksesoris->type_desktop  }}</p></td>
                                            <td><p>{{ $aksesoris->qty  }}</p></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            </table>
