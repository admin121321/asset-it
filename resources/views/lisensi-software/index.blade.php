                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ route('lisensi-software.pdf') }}" class="btn btn-primary mb-4">Export PDF</a>
                                <!-- DataTables -->
                                <div align="right">
                                        ...
                                        <div class="card">
                                            <div class="card-body">            
                                                <div class="d-inline-block">
                                                    <h3 class="text-black">{{ DB::table('lisensi_software')->where('sisa_stok','0')->count(); }}</h3>
                                                ...
                                                &nbsp;
                                                <div class="d-inline-block">
                                                    <h3 class="text-black">{{ DB::table('lisensi_software')->where('sisa_stok','1')->count(); }}</h3>
