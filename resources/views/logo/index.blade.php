                            ...
                            <div class="card-body">
                                ...
                                <div class="section-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <br />
                                            <table class="table table-striped table-bordered zero-configuration kategori_datatable"> 
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Nama Kategori</th>
                                                ...
                                                <form method="post" id="sample_form" class="form-horizontal">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Logo: </label>
                                                            <input type="text" name="gambar_logo" id="gambar_logo" class="form-control" />
                                                        </div>
        ...
        ***********************************-->
        ...
        $(document).ready(function() {
            var table = $('.kategori_datatable').DataTable({
                ...
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'gambar_logo', name: 'gambar_logo'},
