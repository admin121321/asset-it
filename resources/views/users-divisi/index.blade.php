...
$(document).ready(function() {
    ...
    $('#sample_form').on('submit', function(event){
        ...
        if($('#action').val() == 'Add')
        {
            action_url = "{{ route('users-divisi.store') }}";
        }
 
        if($('#action').val() == 'Edit')
        {
            action_url = "{{ route('users-divisi.update') }}";
        }
    ...
    $(document).on('click', '.edit', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#nama_divisi').val(data.result.nama_divisi);
                $('#hidden_id').val(id);
